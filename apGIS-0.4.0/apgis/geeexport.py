...
class Export:
    ...
    class Image:
        ...
        def __process_image_export__(image: ee.Image,
            ...
            Returns:
                A list of ee.Image objects for each product in the requestList
            Raises:
                TypeError:      if parameter type checks fail.
                ValueError:     if image is not associated with Sensor ID in requestList.
        ...
        def toDrive(image: ee.Image,
            ...
            Returns:
                A list of unstarted Tasks.
            Raises:
                TypeError:          if parameter type checks fail.
                ValueError:         if if image is not associated with Sensor ID in requestList.
    ...
    class ImageCollection:
        ...
        def __process_image_collection_export__(imageCol: ee.ImageCollection,
            ...
            Keyword Args:
                ...
                requestList:    A RequestList object which contains in a list of strings, the products to be
                                ...
                                and sensor names along with bands required to be generated.
            Returns:
                A list containing a list of ee.Image objects for each Image in the Collection.
                The list of Images contains an Image for each product in the requestList
            Raises:
                TypeError:      if parameter type checks fail.
        ...
        def toDrive(imageCol: ee.ImageCollection,
            ...
            Args:
                ...
                formatOptions:      A dictionary of string keys to format specific options.
            Returns:
                A list of lists that contain unstarted Tasks.
            Raises:
                TypeError:          if parameter type checks fail.
