...
class Date:
    ...
    Can be initialised with the following parameters:
        -  An ee.Date.
    ...
    def advanceDelta(self, delta: float, unit: str):
        ...
        Returns:
            a Date that has to be advanced by the specified parameters.
        Raises:
            ValueError: if the unit passed for delta advancing is not allowed.
    ...
    def nextDay(self):
        ...
        Returns:
            a Date that has to be advanced by 1 day.
