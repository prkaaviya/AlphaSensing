"""
Module for Data Structure and Format conversions.
...
def areaUnitConversion(area: Union[int, float],
    ...
    Returns:
        A float area value in the converted unit.
    Raises:
    ...
    try:
        ...
        raise ArithmeticError("Area Conversion Failed @ area unit conversion: {e}")
