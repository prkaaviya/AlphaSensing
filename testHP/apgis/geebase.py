...
def genCollection(sensor: str,
                  ...
                  daterange: DateRange,
                  cloudCover: int = None,
                  *args, **kwargs) -> ee.ImageCollection:
    ...
    *Generating a Landsat-8 SR Collection with under 5% Cloud Cover:*\n
    ...
    if cloudCover is not None and isinstance(cloudCover, int):
...
def fixMetadata(image: ee.Image,
    ...
    *Fixing a Sentinel-2 L2A Image, setting a pixelType and a footprint:*\n
    ...
    try:
        ...
        raise apexception.EERuntimeError(f"Image Metadata Rebuild Failed @ Metadata Generation: {e}")
    ...
    try:
        ...
        raise apexception.EERuntimeError(f"Image Metadata Rebuild Failed @ Image Rebuilding: {e}")
